...
LOCAL_APPS = [
    ...
    "wifi_zones_api.vouchers",
    "wifi_zones_api.external_apis",
...
CORS_ALLOWED_ORIGINS = env("CORS_ORIGINS", default=["https://confirmation.datinvoz.com"])
...
URL = env(
    "CLIENT_URL",
    default="wifi-zones-api.datinvoz.com",
)
# RUIJIE
